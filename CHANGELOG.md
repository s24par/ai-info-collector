...
- Changed the default summary target from 200 to 300 characters and now retain over-target summaries with a warning instead of dropping the article.
- Prefer fetched article-page HTML text for summarization, falling back to feed `content` and then `summary`; articles with no usable content are skipped.
