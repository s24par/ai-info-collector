...
def test_rss_collector_prefers_page_even_when_summary_exists(summary: str) -> None:
    ...
    <rss version="2.0"><channel>
      <item><title>Article with page content</title>
        <link>https://example.com/article</link>
        <pubDate>Fri, 28 Aug 2026 12:00:00 GMT</pubDate>
...
def test_rss_collector_falls_back_to_summary_when_page_and_content_are_empty() -> None:
    feed = """<?xml version="1.0"?>
    <rss version="2.0"><channel>
      <item><title>Summary article</title>
        <link>https://example.com/article</link>
        <pubDate>Fri, 28 Aug 2026 12:00:00 GMT</pubDate>
        <description><![CDATA[<p>Summary from feed.</p>]]></description>
      </item>
    </channel></rss>"""
    ...
    assert result.articles[0].content == "Summary from feed."
